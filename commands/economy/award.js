module.exports = ({
    ...
    $description[<@$findMember[$messageSlice[1]]> ha sido premiado con $message[1]💴!]
    $setGlobalUserVar[money;$sum[$getGLobalUserVar[money;$findMember[$messageSlice[1]]];$message[1]];$findMember[$messageSlice[1]]]
    $onlyIf[$isBot[$findMember[$message[2]]]==false;{description: Por qué no intentas mencionar a una usuario que no es un bot?}{color:RANDOM}]
